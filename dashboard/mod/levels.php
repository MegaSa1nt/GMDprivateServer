...
if(!$person['success']) exit(Dashboard::renderErrorPage(Dashboard::string("unlistedLevelsTitle"), Dashboard::string("errorLoginRequired")));

if(!Library::checkPermission($person, "dashboardModeratorTools")) exit(Dashboard::renderErrorPage(Dashboard::string("unlistedLevelsTitle"), Dashboard::string("errorNoPermission"), '../'));
...
exit(Dashboard::renderPage("general/wide", Dashboard::string("unlistedLevelsTitle"), "../", $fullPage));
?>