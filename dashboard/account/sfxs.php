...
if(!$person['success']) exit(Dashboard::renderErrorPage(Dashboard::string("yourSFXsTitle"), Dashboard::string("errorLoginRequired")));
$accountID = $person['accountID'];

$order = "reuploadTime";
$orderSorting = "DESC";
$filters = ["sfxs.reuploadID = '".$accountID."'", "sfxs.isDisabled = 0"];
...
exit(Dashboard::renderPage("general/wide", Dashboard::string("yourSFXsTitle"), "../", $fullPage));
?>