...
$string["logout"] = "יציאה";
$string["login"] = "כניסה";
$string["wrongNickOrPass"] = "!שם משתמש או סיסמה לא נכונה";
$string["invalidid"] = "ID לא נכון!";
$string["loginBox"] = "כניסה לחשבון";
$string["loginSuccess"] = "!ההכנסה לחשבון הוצלחה";
$string["loginAlready"] = "!אתה כבר נכנסת";
$string["clickHere"] = "דאשבורד";
$string["enterUsername"] = "הכנס שם משתמש";
$string["enterPassword"] = "הכנס סיסמה";
$string["loginDesc"] = "!כאן אתה יכול להיכנס לחשבון שלך";
  
$string["register"] = "הירשמות";
$string["registerAcc"] = "הירשמות לחשבון";
$string["registerDesc"] = "תיצור את החשבון שלך!";
$string["repeatpassword"] = "הכנס סיסמה עוד פעם";
$string["email"] = "מייל";
$string["repeatemail"] = "הכנס מייל עוד פעם";
