				...
				<ul class="nav navbar-nav ml-auto">';
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
							...
							<a class="dropdown-item dontblock" href="lang/switchLang.php?lang=HE" title="Translated by OmriOn"><div class="icon flag"><img class="imgflag" src="incl/flags/il.png?2"></div>עברית</a>
