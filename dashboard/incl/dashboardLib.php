		...
		if(isset($_SESSION["accountID"]) AND $_SESSION["accountID"] != 0) {
			...
			if($gs->checkPermission($_SESSION["accountID"], "dashboardModTools")){
				echo '<li class="nav-item dropdown '.$modActive.'">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">';
							if($gs->checkPermission($_SESSION["accountID"], "dashboardBanTools")) echo '<a type="button" href="account/banPerson.php" onclick="a(\'account/banPerson.php\')"class="dropdown-item"><div class="icon"><i class="fa-solid fa-gavel"></i></div>'.$this->getLocalizedString("leaderboardBan").'</a>';
							if($gs->checkPermission($_SESSION["accountID"], "dashboardBanTools")) echo '<a type="button" href="stats/banList.php" onclick="a(\'stats/banList.php\')"class="dropdown-item"><i class="fa-solid fa-gavel" style="position: absolute;font-size: 10px;margin: 0px 5px 5px -7px;" aria-hidden="false"></i><div class="icon"><i class="fa-solid fa-list"></i></div>'.$this->getLocalizedString("banList").'</a>';
