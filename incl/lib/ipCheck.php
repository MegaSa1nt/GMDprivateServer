...
class ipCheck {
	...
	public function checkCloudflareProxy() {
		include __DIR__."/../../config/security.php";
		if(!isset($cloudflareProxy)) global $cloudflareProxy;
		if(!$cloudflareProxy) return;
		if(!$this->isCloudflareIP($_SERVER['REMOTE_ADDR'])) {
