...
if($enableCommentLengthLimiter && $commentLength > $maxAccountCommentLength) exit("temp_0_You cannot post account comments above the $maxAccountCommentLength character limit! Yours was $commentLength.");
