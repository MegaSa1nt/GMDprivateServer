...
foreach($mapPacks['mapPacks'] AS &$mapPack) {
	...
	$mapPackString .= "1:".$mapPack["ID"].":2:".Escape::gd(Escape::translit($mapPack["name"])).":3:".$mapPack["levels"].":4:".$mapPack["stars"].":5:".$mapPack["coins"].":6:".$mapPack["difficulty"].":7:".$mapPack["rgbcolors"].":8:".$mapPack["colors2"]."|";
}
